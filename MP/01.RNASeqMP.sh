...
# Quality trimming
trimmomatic SE -threads 30 MP.rep1.fastq.gz rep1.filtered.fastq.gz LEADING:22 TRAILING:22 SLIDINGWINDOW:4:26 MINLEN:20 ILLUMINACLIP:TruSeq3-SE:2:30:10
trimmomatic SE -threads 30 MP.rep2.fastq.gz rep2.filtered.fastq.gz LEADING:22 TRAILING:22 SLIDINGWINDOW:4:26 MINLEN:20 ILLUMINACLIP:TruSeq3-SE:2:30:10
