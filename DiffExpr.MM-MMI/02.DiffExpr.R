...
# Output: 1. MM-MMI.results.tsv          Mel Z MM-MMI Differential expression analysis tabbed file
#         2. MM-MMI.scatterplots.pdf     Scatterplots to control replicas consistency
#         3. MM-MMI.volcanoplot.pdf      VolcanoPlot to display the most prominent down/upregulated genes
#         4. MM-MMI.PCA.pdf              PCA to control replicas consistency
#
...
cairo_pdf("MM-MMI.scatterplots.pdf",width=15,height=10,antialias="default",fallback_resolution = 300,onefile=T)
...
# Plot dispersions
cairo_pdf("MM-MMI.dispersions.pdf",width=15,height=10,antialias="default",fallback_resolution = 300)
...
cairo_pdf("MM-MMI.heatmap.pdf",width=15,height=10,antialias="default",fallback_resolution = 300)
...
cairo_pdf("MM-MMI.PCA.pdf",width=15,height=10,antialias="default",fallback_resolution = 300,onefile=T)
...
## Write results
write.table(resdata, file="MM-MMI.results.tsv",sep='\t')

cairo_pdf("MM-MMI.maplot.pdf",width=15,height=10,pointsize=16,antialias="default",fallback_resolution = 300,onefile=T)
...
cairo_pdf("MM-MMI.volcanoplot.pdf",width=15,height=10,pointsize=16,antialias="default",fallback_resolution = 300,onefile=T)
