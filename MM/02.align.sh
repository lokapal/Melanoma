...
# Output: 1. rnaseq.MM.rep1.bam          Mel Z MM RNASeq replica 1 alignment to hg38
#            rnaseq.MM.rep2.bam          Mel Z MM RNASeq replica 2 alignment to hg38
#         2. MM_Pearson.pdf              Mel Z MM RNASeq replica consistency check: Pearson correlation
#            MM_Spearman.pdf             Mel Z MM RNASeq replica consistency check: Spearman correlation
#
# Dependency tools:
...
mv rep1.Aligned.sortedByCoord.out.bam rnaseq.MM.rep1.bam
samtools index -@ 16 rnaseq.MM.rep1.bam
mv rep2.Aligned.sortedByCoord.out.bam rnaseq.MM.rep2.bam
samtools index -@ 16 rnaseq.MM.rep2.bam
# Quality Control to check consistency between replicas (optional)
multiBamSummary bins -p 30 -b rnaseq.MM.rep1.bam rnaseq.MM.rep2.bam -o res12.npz
plotCorrelation -in res12.npz --skipZeros -c spearman --removeOutliers -p scatterplot -o MM_Spearman.pdf --labels rep1 rep2 --log1p
plotCorrelation -in res12.npz --skipZeros -c pearson  --removeOutliers -p scatterplot -o MM_Pearson.pdf  --labels rep1 rep2 --log1p
